...
リンクをクリックしたりウィクショナリー連携が起動すると、インターネットの基本的な情報（IPアドレス、Cookieなど）と選択したテキストが送信されます。HTTPリファラ（どのサイトから訪れたかを示す情報）は除外しています。  
必要に応じて、ファビコンをインターネットからダウンロードして保存します。  
その他の情報を収集および送信しません。  

## お問い合わせ
バグ報告、要望、お問い合わせ等、GitHubのissuesを使用してください。書き込みは一般に公開されます。  
